...
export const TAG_CONFIG = {
    "非编码存储科技": {
        ...
        "大宗仓库": ["分类打包大宗", "潜影盒分类大宗", "四边形大宗"],
        "不可堆叠相关": ["不可堆叠分离", "不可堆叠分类"],
        "多物品相关": ["多物品分类 (MIS)", "多种类潜影盒分类 (MBS)"]
    },
    "潜影盒处理": {
        "潜影盒打包机": ["分类打包", "混杂打包", "自适应打包", "精密打包", "缓存打包", "可访问打包", "比例打包", "堆分打包", "计数打包"],
        ...
        "分盒器相关": ["潜影盒分盒器", "矿车分盒器"],
        "合并器相关": ["潜影盒合并器", "不满盒临时存储", "分组器 (Grouper)", "潜影盒配对器"],
        "潜影盒填充度分类": [],
        "空盒仓库":[]
    },
    "编码存储科技": {
        ...
        "编码器": ["二进制", "其他编码器"],
        "解码器": ["二进制", "十进制", "十六进制", "强模", "水道速", "方块事件深度(BED)"],
        "其他组件": []
    },
    "其他杂物": {
